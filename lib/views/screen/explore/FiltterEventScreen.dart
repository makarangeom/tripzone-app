...
class FiltterEventScreen extends StatelessWidget {
    const FiltterEventScreen({Key? key}) : super(key: key);
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
    ...
    RangeLabels _rangeLabels = const RangeLabels('40', '80');
                                            ...
                                            Container(
                                                ...
                                                child: RichText(
                                                    text: TextSpan(
                                                        ...
                                                        children: <TextSpan>[
                                                            TextSpan(
                                                                text: _currentRangeValues.start.toString() + '\$' + ' - ' + _currentRangeValues.end.toString() + '\$',
